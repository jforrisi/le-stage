...
class VentasLineasInline(admin.TabularInline):
...
@admin.register(VentasCabezal)
class VentasCabezalAdmin(ModelAdmin):
...
@admin.register(VentasLineas)
class VentasLineasAdmin(ModelAdmin):
